...
O fluxo OAuth deverá utilizar este esquema de URL para retorno ao Companion.
...
- Implementar monitoramento contínuo da reprodução.
- Implementar sincronização automática com a ESP32.
- Implementar atualização do State Global.
- Implementar interface do módulo Spotify.
