...
- A localização do usuário será obtida automaticamente utilizando os serviços de localização do iOS.
...
- Implementar persistência das configurações da aplicação.
- Implementar configuração de localização automática e manual.
- Integrar a configuração de localização com o módulo Weather.
- Implementar envio das credenciais Wi-Fi para a ESP32.
- Atualizar o estado da conexão Wi-Fi conforme resposta do firmware.
- Implementar interface do módulo Settings.
