...
Caso nenhuma cidade esteja configurada, o Backend deverá obter automaticamente a localização do usuário utilizando os serviços de localização do iOS.
...
- Implementar integração com a API Open-Meteo.
- Implementar suporte aos modos Cidade Manual e Localização Automática.
- Implementar obtenção da localização utilizando os serviços de localização do iOS.
- Implementar watcher meteorológico.
- Implementar sincronização automática com a ESP32.
- Implementar atualização do State Global.
- Implementar interface do módulo Weather.
- Implementar conversão oficial de `weather_code` para os índices utilizados pelo firmware.
- Implementar otimização para evitar sincronizações desnecessárias.
...
- O Backend obtém corretamente a localização do usuário através dos serviços de localização do iOS ou utiliza a cidade configurada em Settings.
