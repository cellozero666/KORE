...
Criar a estrutura base da interface do K.O.R.E. Companion, definindo o layout principal da aplicação e preparando a navegação entre os módulos.
...
Os itens da Sidebar deverão estar visíveis e preparados para futura implementação, mesmo que ainda não possuam funcionalidade.
...
* A Sidebar é exibida corretamente.
