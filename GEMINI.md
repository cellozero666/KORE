...
Melchior é responsável por projetar toda a experiência visual do ecossistema K.O.R.E.
...
* Criar especificações de interface para implementação.
...
Belthazar implementa.

Gaspar define a arquitetura.
