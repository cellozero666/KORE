...
FaceType faceBeforeNotification = FACE_HAPPY;
...
void updateNotification() {
        ...
        millis() - notificationEmotionStarted >= 5000)
    {
        ...
        setFace(faceBeforeNotification);
        dequeueNotification();
    }
}
...
)
{
  ...
  if (!notificationActive && !notificationEmotionActive)
  {
    faceBeforeNotification = currentFace;
  }
